 ...
 * one parameterized invocation alongside {@link CrossPartitionSplitOrderingImmutableKeyRangeIT}.
 */
public class CrossPartitionSplitOrderingMutableKeyRangeIT extends CrossPartitionSplitOrderingTestBase {

    @Test
    public void shouldDeliverFollowUpWriteExactlyOnceAndInOrderAcrossBackgroundPartitionSplits()
            throws InterruptedException, ExecutionException {
        runTest(PartitionMode.MUTABLE_KEY_RANGE);
    }
}
